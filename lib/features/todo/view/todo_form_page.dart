...
import 'package:todo_app_api/shared/widgets/styles.dart';
...
class TodoFormPage extends GetView<TodoController> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {// jalankan kode SETELAH UI pertama selesai digambar (render frame pertama)
      if (isCreate) {
